...
bool	CheckSideE1(float x1, float y1, float r, float x2, float y2, float w2, float	h2);
				//敵							//マップ
bool	CheckSideE2(float x1, float y1, float r, float x2, float y2, float w2, float	h2);//矩形
				//敵							//マップ
bool	CheckSideE3(float x1, float y1, float r, float x2, float y2, float w2, float	h2);//矩形
				//敵							//マップ
